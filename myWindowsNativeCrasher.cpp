...
void CreateReport()
{
	const __wchar_t  *xml = L"<report><process>"
		"<exception>"
			...
			"<func><![CDATA[MyWindowsNativeCrasher!MemoryException]]></func>"
			"<file>/www/bugsplatAutomation/MyWindowsNativeCrasher/MyWindowsNativeCrasher.cpp</file>"
			"<line>143</line>"
			"<registers>"
				"<cs>0023</cs>"
				"<ds>002b</ds>"
		...
		"<modules numloaded=\"2\">"
		"<module>"
			"<name>MyWindowsNativeCrasher</name>"
			"<order>1</order>"
			"<address>01320000-01457000</address>"
			"<path>C:/www/BugsplatAutomation/BugsplatAutomation/bin/x64/Release/temp/BugSplat/bin/MyWindowsNativeCrasher.exe</path>"
		...
		"<thread id=\"0\" current=\"yes\" event=\"yes\" framecount=\"3\">"
			"<frame>"
				"<symbol><![CDATA[MyWindowsNativeCrasher!MemoryException]]></symbol>"
				"<file>/www/bugsplatAutomation/MyWindowsNativeCrasher/MyWindowsNativeCrasher.cpp</file>"
				"<line>143</line>"
				"<offset>0x35</offset>"
			"</frame>"
			"<frame>"
				"<symbol><![CDATA[MyWindowsNativeCrasher!wmain]]></symbol>"
				"<file>C:/www/BugsplatAutomation/BugsplatAutomation/BugSplat/samples/MyWindowsNativeCrasher/MyWindowsNativeCrasher.cpp</file>"
				"<line>83</line>"
				"<offset>0x239</offset>"
			"</frame>"
			"<frame>"
				"<symbol><![CDATA[MyWindowsNativeCrasher!__scrt_wide_environment_policy::initialize_environment]]></symbol>"
